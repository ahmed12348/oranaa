...
let router = new Router({
    ...
    routes: [
        ...
        {
            path: "/admin/gradeitem",
            name: "gradeitem",
            component: () => import("./views/admin/gradeitem.vue"),
            meta: {
                // requiresAuth: true,
                layout: AdminLayout
            }
        },
        {
            path: "/admin/date",
            name: "date",
            component: () => import("./views/admin/date.vue"),
            meta: {
                // requiresAuth: true,
                layout: AdminLayout
            }
        ...
        {
            path: "/admin/StudentsIndex",
            name: "StudentsIndex",
            component: () => import("./views/admin/StudentsIndex.vue"),
            meta: {
                // requiresAuth: true,
                layout: AdminLayout
            }
