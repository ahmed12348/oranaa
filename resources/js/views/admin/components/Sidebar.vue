<template>
    ...
    >
      ...
      >
        ...
        <div class="sidebar-brand-text mx-3">LMS Vue</div>
      </router-link>
      ...
      <li class="nav-item ">
        <router-link class="nav-link" to="/admin/students">
          <i class="fas fa-opencart fa-tachometer-alt"></i>
      ...
      <li class="nav-item ">
        <router-link class="nav-link" to="/admin/levels">
          <i class="fas fa-opencart fa-tachometer-alt"></i>
      ...
      <li class="nav-item ">
        <router-link class="nav-link" to="/admin/gradeitem">
          <i class="fas fa-opencart fa-tachometer-alt"></i>
          <span>Grade Items</span></router-link>
      </li>
      <!-- Divider -->
