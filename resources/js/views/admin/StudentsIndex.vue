    ...
    <div>
        ...
        <div class="d-flex justify-content-between align-content-center mb-2">
            <div class="d-flex">
                ...
                <div>
                    <div class="d-flex align-items-center ml-4">
                        <label for="paginate" class="text-nowrap mr-2 mb-0">FilterBy Levels</label>
                        <select v-model="selectedLevel" class="form-control form-control-sm">
                    ...
                    <tr>
                        ...
                        <th>
                            <a href="#" @click.prevent="change_sort('name')"
                                >Student's Name</a>
                            <span
                                v-if=" sort_direction == 'desc' &&sort_field == 'name'">&uarr;</span>
                            <span
                                v-if="sort_direction == 'asc' && sort_field == 'name'">&darr;</span>
                        </th>
                        <th>
                        ...
                        <th><a href="#" @click.prevent="change_sort('address')">Address</a>
...
export default {
    ...
    watch: {
        ...
        selectedLevel: function(value) {
            ...
            axios
                .get("/students?level=" + this.selectedLevel)
                .then(response => {
